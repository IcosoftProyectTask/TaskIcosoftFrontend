...
import { getHoursDifference, formatTimeForDisplay } from '../../components/Productivity/utils';
...
const PriorityChart = ({ data }) => {
    ...
    return priorities.map(priority => {
      ...
      const avgTime = filteredTasks.length > 0
        ? filteredTasks.reduce((sum, t) => {
            ...
            return sum + (hours !== null ? parseFloat(hours) : 0);
      ...
      return {
        name: priority,
        value: avgTime,
        formattedValue: formatTimeForDisplay(avgTime),
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 rounded-lg shadow">
      <h3 className="font-medium mb-3 sm:mb-4 text-gray-800 dark:text-white text-sm sm:text-base">Tiempo de resolución por prioridad</h3>
      <div className="h-64">
        {resolutionTimeByPriority.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Tooltip
                formatter={(value, name, props) => [props.payload.formattedValue, 'Tiempo promedio']}
